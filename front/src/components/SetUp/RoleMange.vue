  ...
  <div>
    <div class="head">
      ...
      <div class="head-action">
        <el-input v-model="customFilters[0].vals" prefix-icon="el-icon-search" placeholder="搜索角色标识" class="class_input_width">
        </el-input>
    ...
    <div class="content">
      <data-tables-server :data="RolesData.ListData" :filters="customFilters" :total="RolesData.total" @query-change="getData"
